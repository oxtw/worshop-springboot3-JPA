...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2019-06-20T19:53:07Z"), u1); //strings no formato ISO 8601
		Order o2 = new Order(null, Instant.parse("2019-07-21T03:42:10Z"), u2); //Ano-mes-dia letra T horas:min:seg letra Z
		Order o3 = new Order(null, Instant.parse("2019-07-22T15:21:22Z"), u1);//horário padrão UTC, timezone GNT. Pode ser configurado por qualquer dev no mundo para um horário local.
