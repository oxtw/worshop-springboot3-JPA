...
package com.migueljava.course.resources.exceptions;
...
@ControllerAdvice //esta annotation que irá interceptar as exceções para que esse objeto possa exectar o tratamento.
public class ResourceExceptionHandler {
	
	//Método para o ResourceNotFoundException.
	...
	//método para o DatabaseException
